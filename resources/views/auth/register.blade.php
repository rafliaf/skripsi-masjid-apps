        ...
        <div class="col-md-6">
            <main class="form-registration">
                <form action="/register" method="post">
                    @csrf
                    <img class="mb-4 rounded mx-auto d-block" src="assets/auth/img/logo_profile.jpg" alt=""
                        width="120" height="120">
                    <h1 class="h3 mb-3 fw-normal text-center">Form Pendaftaran</h1>
                    <div class="form-group">
                        <label for="nama_masjid">Nama masjid</label>
                        <input type="text" name="nama_masjid"
                            class="form-control @error('nama_masjid') is-invalid @enderror" id="nama_masjid"
                            value="{{ old('nama_masjid') }}" autofocus required>
                        @error('nama_masjid')
                    ...
                    <div class="form-group mt-3">
                        ...
                        <textarea type="text" name="alamat_masjid" class="form-control @error('alamat_masjid') is-invalid @enderror"
                            id="alamat_masjid" style="height: 100px" required>{{ old('alamat_masjid') }}</textarea>
                        @error('alamat_masjid')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="password" name="password"
                            class="form-control rounded-bottom @error('password') is-invalid @enderror" id="myInput"
                            required>
                        @error('password')
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <div class="mb-2 mt-2 form-check">
                        <input id="tampilPassword" type="checkbox" class="form-check-input show-pass"
                            onclick="myFunction()">
                        <label class="form-check-label show-pass" for="tampilPassword">Tampilkan password</label>
                    </div>
                            ...
                            <div class="modal-body text-center">
                                ...
                                <div class="mt-3">
                                    <button type="button" class="btn btn-warning"
                                        onclick="onClickNext()">Selanjutnya</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <small class="d-block text-center mt-4 mb-2">Sudah Punya Akun? Silahkan <a href="login"
