...
<link rel="stylesheet" href="{{ asset('assets/takmir_masjid/css/detailMosqueProgram.css') }}">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Detail Program Takmir Masjid</h1>
                        <p class="mt-2">{{ $getData->nama_masjid }}</p>
                    </div>
                    <div class="col-sm-6 mb-3">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                                <a href="#">Detail Program takmir masjid</a>
                            </li>
                            <li class="breadcrumb-item active">
                                Tampilan detail program takmir masjid
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <table width="100%">
                            <thead>
                              <tr class="col-md-12">
                                ...
                                <td width="1%">:</td>
                                <td style="padding-left: 5px;">{{ $program->jenisProgram->jenis_program }}</td>
                              </tr>
                              <tr class="col-md-12">
                              ...
                              <tr class="col-md-12">
                                ...
                                <td width="1%">:</td>
                                <td style="padding-left: 5px;">{{ \Carbon\Carbon::parse($program->tgl_mulai)->translatedFormat('d F Y H:i') }} WIB</td>
                              </tr>
                              <tr class="col-md-12">
                                <td class="custom-width-td" width="180px"><b>Tanggal selesai</b></td>
                                <td width="1%">:</td>
                                <td style="padding-left: 5px;">{{ \Carbon\Carbon::parse($program->tgl_selesai)->translatedFormat('d F Y H:i') }} WIB</td>
                              </tr>
                              <tr class="col-md-12">
                                <td class="custom-width-td" width="180px"><b>Penanggung jawab</b></td>
                                <td width="1%">:</td>
                                <td style="padding-left: 5px;">{{ $program->dataInduk->nama_lengkap }}</td>
                              </tr>
                              <tr class="col-md-12">
                                <td class="custom-width-td" width="180px"><b>No.telepon</b></td>
                                <td width="1%">:</td>
                                <td style="padding-left: 5px;">{{ $program->dataInduk->no_wa }}</td>
                              </tr>
                              <tr class="col-md-12">
