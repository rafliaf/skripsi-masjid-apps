...
<link rel="stylesheet" href="{{ asset('assets/takmir_masjid/css/mosqueProgram.css') }}">
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Program Takmir Masjid</h1>
                        <p class="mt-2">{{ $getData->nama_masjid }}</p>
                    </div>
                    <div class="col-sm-6 mb-3">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                                <a href="#" style="text-decoration: none;">Program takmir masjid</a>
                            </li>
                            <li class="breadcrumb-item active">
                                Tampilan program takmir masjid
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="card col-md-12">
                    ...
                    {{-- btn --}}
                    <div class="m-3">
                        <button class="btn btn-success" onclick="onAddProgramClicked()">Tambah program</button>
                        <button class="btn btn-success" 
                                onclick="onAddDataClicked()" 
                                {{ $type_program_exists ? '' : 'disabled' }}>
                            Tambah data
                        </button>
                    </div>                    
                    <div class="col-md-12">
                        ...
                        <table id="myTable" class="table table-striped">
                            ...
                            <tbody id="tableBody">
                                ...
                                <tr>
                                    ...
                                    <!-- Use translatedFormat for Indonesian format -->
                                    <td>{{ \Carbon\Carbon::parse($program->tgl_mulai)->translatedFormat('d F Y H:i') }} WIB</td>
                                    <td>{{ \Carbon\Carbon::parse($program->tgl_selesai)->translatedFormat('d F Y H:i') }} WIB</td>
