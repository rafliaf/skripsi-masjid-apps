...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Program Takmir Masjid</h1>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <form action="{{ route('program_takmir.update', $program->id) }}" method="POST" style="margin-top: 20px">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row justify-content-center" hidden>
                            <label for="no_telepon" class="col-md-3 col-form-label">No. Telepon</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="no_telepon" name="no_telepon" value="{{ old('no_telepon', $penanggung_jawab->no_wa) }}" placeholder="Masukkan No. Telepon">
                            </div>
                        </div>                        
        ...
        <script src="{{ asset('assets/takmir_masjid/js/editProgramTakmir.js') }}"></script>
@endsection
