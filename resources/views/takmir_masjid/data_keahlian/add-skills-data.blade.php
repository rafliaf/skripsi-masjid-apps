                    ...
                    <form method="POST" action="{{ route('storeDataKeahlian') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <div class="col-sm-6">
                                    <select class="custom-select @error('data_induk_id') is-invalid @enderror" name="data_induk_id" required>
                                        <option hidden>Cari nama warga...</option>
                                        @foreach($data_warga as $warga)
                                            <option value="{{ $warga->id }}" {{ old('data_induk_id') == $warga->id ? 'selected' : '' }}>
                                                {{ $warga->nama_lengkap }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <div class="col-sm-6">
                                    <select class="custom-select @error('jenis_keahlian_id') is-invalid @enderror" name="jenis_keahlian_id" required>
                                        <option hidden>Jenis keahlian...</option>
                                        @foreach($jenis_keahlian as $keahlian)
                                            <option value="{{ $keahlian->id }}" {{ old('jenis_keahlian_id') == $keahlian->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="deskripsi_keahlian" class="form-control @error('deskripsi_keahlian') is-invalid @enderror" value="{{ old('deskripsi_keahlian') }}" placeholder="Deskripsi keahlian">
                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="keahlian_lain" class="form-control @error('keahlian_lain') is-invalid @enderror" value="{{ old('keahlian_lain') }}"  placeholder="Keahlian lain">
                                    @error('keahlian_lain')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <select class="form-control custom-select @error('is_sertifikat') is-invalid @enderror" id="sertifikat" name="is_sertifikat" onchange="toggleCertificateDescription()">
                                            <option hidden>Jika memiliki sertifikat</option>
                                            <option value="ya" {{ old('is_sertifikat') == 'ya' ? 'selected' : '' }}>Ya</option>
                                            <option value="tidak" {{ old('is_sertifikat') == 'tidak' ? 'selected' : '' }}>Tidak</option>
                                        </select>
                                        @error('is_sertifikat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
