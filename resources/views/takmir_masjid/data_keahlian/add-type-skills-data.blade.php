                        ...
                        <div class="form-group row justify-content-center" id="inputContainer">
                            @if ($jenisKeahlian->isEmpty())
                                <div class="input-group row justify-content-center" id="inputGroup-1">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control margin-top-20" name="jenis_keahlian[]"
                                            id="inputNama-1" placeholder="Masukkan keahlian" required>
                                    </div>
                                    <div style="margin-left: 10px; display: flex; align-items: flex-end; gap: 5px;">
                                        ...
                                        <button type="button" class="btn btn-danger btn-delete"
                                            onclick="onClickRemove(this)" style="display: none;">
                            ...
                            @else
                                @foreach ($jenisKeahlian as $index => $keahlian)
                                    <div class="input-group row justify-content-center mt-4"
                                        id="inputGroup-{{ $index + 1 }}">
                                        <label for="inputNama-{{ $index + 1 }}" class="col-md-3 col-form-label">Keahlian
                                            ke-{{ $index + 1 }}</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control margin-top-20" name="jenis_keahlian[]"
                                                id="inputNama-{{ $index + 1 }}" value="{{ $keahlian->jenis_keahlian }}"
                                                placeholder="Jenis keahlian" disabled>
                                        </div>
                                        <div style="margin-left: 10px; display: flex; align-items: flex-end; gap: 5px;">
                                            <button type="button" class="btn btn-success btn-add" onclick="onClickAdd()">
                                                <span class="fa fa-plus"></span>
