                                ...
                                <thead>
                                    ...
                                    <tr class="col-md-12">
                                        ...
                                        <td style="padding-left: 5px;">
                                            <input class="form-control" type="text" name="alamat_masjid"
                                    ...
                                    <tr class="col-md-12">
                                        ...
                                        <td width="1%">:</td>
                                        <td style="padding-left: 5px;">
                                            <input class="form-control" type="text" name="ketua_masjid"
                                                value="{{ $ketua_masjid }}" placeholder="Masukkan ketua masjid">
                                        </td>
                                    </tr>
                                    <tr class="col-md-12">
                                        ...
                                        <td width="1%">:</td>
                                        <td style="padding-left: 5px;">
                                            <input class="form-control" type="text" name="ketua_takmir"
                                                value="{{ $ketua_takmir }}" placeholder="Masukkan ketua takmir">
                                        </td>
                                    </tr>
                                    <tr class="col-md-12">
                                        ...
                                        <td width="1%">:</td>
                                        <td style="padding-left: 5px;">
                                            <input class="form-control" type="text" name="ketua_remaja_masjid"
                                                value="{{ $ketua_remaja_masjid }}"
                                                placeholder="Masukkan ketua remaja masjid">
                                        </td>
                                    </tr>
                                    <tr class="col-md-12">
                                        ...
                                        <td width="1%">:</td>
                                        <td style="padding-left: 5px;">
                                            <input class="form-control" type="number" name="total_jamaah"
                                                value="{{ $total_jamaah }}" placeholder="Masukkan total jamaah">
                                        </td>
                                    </tr>
                                    <tr class="col-md-12">
                                        ...
                                        <td width="1%">:</td>
                                        <td style="padding-left: 5px;">
                                            <input class="form-control" type="number" name="total_remaja_masjid"
                                                value="{{ $total_remaja_masjid }}"
                                                placeholder="Masukkan total remaja masjid">
                                        </td>
                                    </tr>
                                    <tr class="col-md-12">
                                        ...
                                        <td width="1%">:</td>
                                        <td style="padding-left: 5px;">
                                            <input class="form-control" type="text" name="luas_tanah_masjid"
                                                value="{{ $luas_tanah }}" placeholder="Masukkan luas tanah masjid">
                                        </td>
                                    </tr>
                                    <tr class="col-md-12">
                                        ...
                                        <td width="1%">:</td>
                                        <td style="padding-left: 5px;">
                                            <textarea class="form-control" type="text" name="deskripsi_masjid" placeholder="Masukkan deskripsi masjid"
                                                rows="3">{{ $deskripsi_masjid }}</textarea>
                                        </td>
                                    </tr>
                                </thead>
                            </table>
